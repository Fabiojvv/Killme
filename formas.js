class Formas {
  constructor() {
    this.boardSize = tam; // Tamaño del tablero de ajedrez
    this.tileSize; // Tamaño de cada casilla del tablero
    this.shapes = []; // Arreglo de figuras geométricas
    this.minSize = 10; // Tamaño mínimo de las figuras
    this.maxSize = 30; // Tamaño máximo de las figuras
    this.indiceFigura = 0; // Índice de la figura actual
    this.ultimoCambioF = 0; // Tiempo del último cambio de figura
    this.tiempoDeCambio = 3000; // Intervalo de cambio de figura en milisegundos
  ...
  console.log(voz);
    ...
    for (let i = 0; i < this.boardSize; i++) {
      for (let j = 0; j < this.boardSize; j++) {
        let x = i * tam + this.Dzl - 1.5 ;
        let y = j * tam + this.Dzl -1.5;
